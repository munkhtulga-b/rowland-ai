...
const ChangePasswordButton = () => {
  ...
  return (
    <>
      {_contextHolder}
      <div
        className="tw-p-6 tw-rounded-2xl tw-bg-grayLight hover:tw-bg-slate-200 tw-flex tw-text-2xl tw-text-secondaryGray tw-flex-row tw-justify-between hover:tw-cursor-pointer"
        onClick={showModal}
      >
